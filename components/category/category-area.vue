        ...
        <div class="col-xl-12">
          <div class="tp-category-slider-5">
            <swiper
              ...
              class="tp-category-slider-active-5 swiper-container mb-50"
            >
              <swiper-slide
                v-for="item in category_items"
                :key="item.id"
                class="tp-category-item-5 p-relative z-index-1 fix"
                data-bg-color="#E5EFE2"
              >
            ...
            <div
              class="tp-category-5-swiper-scrollbar tp-swiper-scrollbar"
            ></div>
          </div>
        </div>
      </div>
