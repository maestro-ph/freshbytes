      ...
      <div class="tp-header-5 pl-25 pr-25" style="background-color: #678e61">
        <div class="container-fluid">
          <div class="row align-items-center">
            <div class="col-xxl-2 col-xl-3 col-6">
              <div class="tp-header-left-5 d-flex align-items-center">
                <div class="tp-header-hamburger-5 mr-15 d-none d-lg-block">
                  <button
                    @click="handleActive"
                    class="tp-hamburger-btn-2 tp-hamburger-toggle"
                  >
                    <span></span>
                    <span></span>
                    <span></span>
                ...
                <div class="logo">
                  <nuxt-link href="/">
                    <img
                      src="/images/logo/FreshBytes_NewWhiteLogo.svg"
                      alt="logo"
                    />
                  </nuxt-link>
                </div>
            ...
            <div class="col-xxl-2 col-xl-3 col-6">
              <div
                class="tp-header-right-5 d-flex align-items-center justify-content-end"
              >
                ...
                <div class="tp-header-action-5 d-flex align-items-center ml-20">
                  ...
                  <div
                    class="tp-header-action-item-5 d-none d-sm-block d-xxl-none"
                  >
                    <button
                      type="button"
